...
The [sh/runtests.sh](./sh/runtests.sh) script runs all or selected tests.
...
See the [development documentation](https://sergei-mironov.github.io/litrepl/development/#other-development-scenatios)
